...
COMMENT ON COLUMN public.list_items.estimated_price_min IS 'AI-estimated minimum retail price in лв (BGN)';
COMMENT ON COLUMN public.list_items.estimated_price_max IS 'AI-estimated maximum retail price in лв (BGN)';
